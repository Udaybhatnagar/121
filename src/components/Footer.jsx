      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <motion.div variants={fadeUp} className="space-y-6">
            <div className="flex items-center gap-3 font-black text-2xl tracking-tight">
              ...
              <span>121DEVELOPER</span>
            </div>

            <p className="text-gray-500 text-sm leading-relaxed max-w-sm">
              Empowering businesses with world-class digital marketing and
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-600 text-[11px] uppercase tracking-[0.3em] font-bold">
            © {new Date().getFullYear()} 121DEVELOPER. All Rights Reserved.
          </p>

          <div className="flex gap-8 text-[11px] uppercase tracking-widest font-bold text-gray-600">
...
const IconBox = ({ icon: Icon, color, children }) => {
  ...
  return (
    <>
      <div
        className={`w-10 h-10 shrink-0 rounded-lg border flex items-center justify-center ${colors[color]}`}
      >
        <Icon size={18} />
      </div>
      <div>{children}</div>
